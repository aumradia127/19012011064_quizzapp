...
class PlayActivity : AppCompatActivity() {
    ...
    private fun correctAlertDialog() {
        ...
        val view = LayoutInflater1.from(this@PlayActivity).inflate(R.layout.correct_dialoag, null)
        builder.setView(view)
        val tvScore = view.findViewById<TextView>(R.id.tvDialog_score)
        val correctOkBtn = view.findViewById<Button>(R.id.correct_ok)
        "Score : $correct".also { tvScore.text = it }
    ...
    private fun wrongAlertDialog() {
        val builder = AlertDialog.Builder(this@PlayActivity)
        val view = LayoutInflater1.from(this@PlayActivity).inflate(R.layout.wrong_dialog, null)
        builder.setView(view)
    ...
    private fun timeOverAlertDialog() {
        val builder = AlertDialog.Builder(this@PlayActivity)
        val view = LayoutInflater1.from(this@PlayActivity).inflate(R.layout.time_over_dialog, null)
        builder.setView(view)
